...
public class Drivetrain implements Updateable {
    ...
    public Drivetrain(RobotMap robotmap) {
        ...
        rf = new SwerveModule( robotmap.Drive_2, robotmap.Drive_E_2, robotmap.Steering_2, 412);
        rb = new SwerveModule( robotmap.Drive_3, robotmap.Drive_E_3, robotmap.Steering_3, 285);
